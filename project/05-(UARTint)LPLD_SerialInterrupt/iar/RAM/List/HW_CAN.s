///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.40.1.53790/W32 for ARM    16/Feb/2014  17:24:01 /
...
//                    D_SerialInterrupt\iar\RAM\List\HW_CAN.s                 /
//                                                                            /
//                                                                            /
///////////////////////////////////////////////////////////////////////////////
...
//  105       PORTB->PCR[18] = PORT_PCR_MUX(2)| PORT_PCR_PE_MASK | PORT_PCR_PS_MASK; 
        LDR.W    R0,??DataTable12_8  ;; 0x4004a048
        MOVW     R1,#+515
        STR      R1,[R0, #+0]
        B.N      ??LPLD_CAN_Init_6
//  106     }
...
??LPLD_CAN_Init_5:
        LDR.W    R0,??DataTable12_9  ;; 0x40049030
        MOV      R1,#+512
        STR      R1,[R0, #+0]
//  110     }
//  111 
...
//  114       PORTB->PCR[19] = PORT_PCR_MUX(2)| PORT_PCR_PE_MASK | PORT_PCR_PS_MASK; 
        LDR.W    R0,??DataTable12_10  ;; 0x4004a04c
        MOVW     R1,#+515
        STR      R1,[R0, #+0]
        B.N      ??LPLD_CAN_Init_8
//  115     }
...
??LPLD_CAN_Init_7:
        LDR.W    R0,??DataTable12_11  ;; 0x40049034
        MOV      R1,#+512
        STR      R1,[R0, #+0]
        B.N      ??LPLD_CAN_Init_8
//  119     }
...
//  125       PORTC->PCR[17] = PORT_PCR_MUX(2)| PORT_PCR_PE_MASK | PORT_PCR_PS_MASK; 
        LDR.W    R0,??DataTable12_12  ;; 0x4004b044
        MOVW     R1,#+515
        STR      R1,[R0, #+0]
...
??LPLD_CAN_Init_9:
        LDR.W    R0,??DataTable12_13  ;; 0x4004d060
        MOVW     R1,#+515
        STR      R1,[R0, #+0]
//  130     }
//  131 
...
//  134       PORTC->PCR[16] = PORT_PCR_MUX(2)| PORT_PCR_PE_MASK | PORT_PCR_PS_MASK; 
        LDR.W    R0,??DataTable12_14  ;; 0x4004b040
        MOVW     R1,#+515
        STR      R1,[R0, #+0]
        B.N      ??LPLD_CAN_Init_8
//  135     }
...
??LPLD_CAN_Init_11:
        LDR.W    R0,??DataTable12_15  ;; 0x4004d064
        MOVW     R1,#+515
        STR      R1,[R0, #+0]
//  139     }
//  140   } 	 
...
`?<Constant "C:\\\\embed\\\\LPLD\\\\LPLD_OS...">`:
        ...
        DC8 5CH, 48H, 57H, 5CH, 48H, 57H, 5FH, 43H
        DC8 41H, 4EH, 2EH, 63H, 0
        DC8 0, 0, 0
