...
//    Cpu mode     =  thumb                                                   /
//    Endian       =  little                                                  /
//    Source file  =  C:\embed\LPLD\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_FLEXBUS. /
//                    c                                                       /
//    Command line =  C:\embed\LPLD\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_FLEXBUS. /
//                    c -D LPLD_K60 -lCN "C:\embed\LPLD\LPLD_OSKinetis_V3\pro /
//                    ject\04-(UART)LPLD_SerialComm\iar\RAM\List\" -lB        /
...
//                    erialComm\iar\RAM\List\HW_FLEXBUS.s                     /
//                                                                            /
//                                                                            /
///////////////////////////////////////////////////////////////////////////////
...
//   98     PORTD->PCR[1]  = PORT_PCR_MUX(5);       // FB_CS0     
        LDR.N    R3,??LPLD_FlexBus_Init_0+0x4  ;; 0x4004c004
        MOV      R4,#+1280
        STR      R4,[R3, #+0]
...
//  104     PORTD->PCR[0]  = PORT_PCR_MUX(5);       // FB_CS1  
        LDR.N    R3,??LPLD_FlexBus_Init_0+0xC  ;; 0x4004c000
        MOV      R4,#+1280
        STR      R4,[R3, #+0]
        B.N      ??LPLD_FlexBus_Init_4
//  105   }
...
//  110     PORTC->PCR[18]  = PORT_PCR_MUX(5);       // FB_CS2
        LDR.N    R3,??LPLD_FlexBus_Init_0+0x10  ;; 0x4004b048
        MOV      R4,#+1280
        STR      R4,[R3, #+0]
        B.N      ??LPLD_FlexBus_Init_4
//  111   }
...
//  116     PORTC->PCR[19]  = PORT_PCR_MUX(5);       // FB_CS3
        LDR.N    R3,??LPLD_FlexBus_Init_0+0x14  ;; 0x4004b04c
        MOV      R4,#+1280
        STR      R4,[R3, #+0]
        B.N      ??LPLD_FlexBus_Init_4
//  117   }
...
//  122     PORTC->PCR[17]  = PORT_PCR_MUX(5);       // FB_CS4
        LDR.N    R3,??LPLD_FlexBus_Init_0+0x18  ;; 0x4004b044
        MOV      R4,#+1280
        STR      R4,[R3, #+0]
        B.N      ??LPLD_FlexBus_Init_4
//  123   }
...
//  128     PORTC->PCR[16]  = PORT_PCR_MUX(5);       // FB_CS5
        LDR.N    R3,??LPLD_FlexBus_Init_0+0x1C  ;; 0x4004b040
        MOV      R4,#+1280
        STR      R4,[R3, #+0]
//  129   }
//  130   
