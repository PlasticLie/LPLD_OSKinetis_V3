///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.40.1.53790/W32 for ARM    16/Feb/2014  16:24:50 /
// Copyright 1999-2012 IAR Systems AB.                                        /
//                                                                            /
//    Cpu mode     =  thumb                                                   /
//    Endian       =  little                                                  /
//    Source file  =  C:\embed\LPLD\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_LPTMR.c  /
//    Command line =  C:\embed\LPLD\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_LPTMR.c  /
...
//                    erialComm\iar\RAM\List\HW_LPTMR.s                       /
//                                                                            /
//                                                                            /
///////////////////////////////////////////////////////////////////////////////
...
// C:\embed\LPLD\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_LPTMR.c
//    1 /**
//    2  * @file HW_LPTMR.c
...
//   52   //清空寄存器
//   53   LPTMR0->CSR = 0x00;                   
        LDR.N    R4,??DataTable7_3  ;; 0x40040000
        MOVS     R5,#+0
        STR      R5,[R4, #+0]
//   54   LPTMR0->PSR = 0x00;
        LDR.N    R4,??DataTable7_4  ;; 0x40040004
        MOVS     R5,#+0
        STR      R5,[R4, #+0]
//   55   LPTMR0->CMR = 0x00;
        LDR.N    R4,??DataTable7_5  ;; 0x40040008
        MOVS     R5,#+0
        STR      R5,[R4, #+0]
//   56    
