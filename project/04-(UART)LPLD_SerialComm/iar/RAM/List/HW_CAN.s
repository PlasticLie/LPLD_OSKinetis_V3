///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.40.1.53790/W32 for ARM    16/Feb/2014  16:24:47 /
// Copyright 1999-2012 IAR Systems AB.                                        /
//                                                                            /
//    Cpu mode     =  thumb                                                   /
//    Endian       =  little                                                  /
//    Source file  =  C:\embed\LPLD\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_CAN.c    /
//    Command line =  C:\embed\LPLD\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_CAN.c    /
...
//                    erialComm\iar\RAM\List\HW_CAN.s                         /
//                                                                            /
//                                                                            /
///////////////////////////////////////////////////////////////////////////////
...
// C:\embed\LPLD\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_CAN.c
//    1 /**
//    2  * @file HW_CAN.c
...
//   94   OSC->CR |= OSC_CR_ERCLKEN_MASK | OSC_CR_EREFSTEN_MASK;
        LDR.W    R5,??DataTable12_2  ;; 0x40065000
        LDRB     R5,[R5, #+0]
        ORRS     R5,R5,#0xA0
        LDR.W    R6,??DataTable12_2  ;; 0x40065000
        STRB     R5,[R6, #+0]
//   95   
//   96   if(canx == CAN0)
        LDR.W    R5,??DataTable12_3  ;; 0x40024000
        CMP      R4,R5
        BNE.N    ??LPLD_CAN_Init_0
//   97     SIM->SCGC6 |= SIM_SCGC6_FLEXCAN0_MASK;
        LDR.W    R5,??DataTable12_4  ;; 0x4004803c
        LDR      R5,[R5, #+0]
        ORRS     R5,R5,#0x10
        LDR.W    R6,??DataTable12_4  ;; 0x4004803c
        STR      R5,[R6, #+0]
        B.N      ??LPLD_CAN_Init_1
//   98   else
//   99     SIM->SCGC3 |= SIM_SCGC3_FLEXCAN1_MASK;
??LPLD_CAN_Init_0:
        LDR.W    R5,??DataTable12_5  ;; 0x40048030
        LDR      R5,[R5, #+0]
        ORRS     R5,R5,#0x10
        LDR.W    R6,??DataTable12_5  ;; 0x40048030
        STR      R5,[R6, #+0]
//  100   
//  101   if(canx == CAN0)
??LPLD_CAN_Init_1:
...
//  105       PORTB->PCR[18] = PORT_PCR_MUX(2)| PORT_PCR_PE_MASK | PORT_PCR_PS_MASK; 
        LDR.W    R2,??DataTable12_6  ;; 0x4004a048
        MOVW     R5,#+515
        STR      R5,[R2, #+0]
        B.N      ??LPLD_CAN_Init_4
//  106     }
...
??LPLD_CAN_Init_3:
        LDR.W    R2,??DataTable12_7  ;; 0x40049030
        MOV      R5,#+512
        STR      R5,[R2, #+0]
//  110     }
//  111 
...
//  114       PORTB->PCR[19] = PORT_PCR_MUX(2)| PORT_PCR_PE_MASK | PORT_PCR_PS_MASK; 
        LDR.W    R2,??DataTable12_8  ;; 0x4004a04c
        MOVW     R3,#+515
        STR      R3,[R2, #+0]
        B.N      ??LPLD_CAN_Init_6
//  115     }
...
??LPLD_CAN_Init_5:
        LDR.W    R2,??DataTable12_9  ;; 0x40049034
        MOV      R3,#+512
        STR      R3,[R2, #+0]
        B.N      ??LPLD_CAN_Init_6
//  119     }
...
//  125       PORTC->PCR[17] = PORT_PCR_MUX(2)| PORT_PCR_PE_MASK | PORT_PCR_PS_MASK; 
        LDR.W    R2,??DataTable12_10  ;; 0x4004b044
        MOVW     R5,#+515
        STR      R5,[R2, #+0]
        B.N      ??LPLD_CAN_Init_8
//  126     }
...
??LPLD_CAN_Init_7:
        LDR.W    R2,??DataTable12_11  ;; 0x4004d060
        MOVW     R5,#+515
        STR      R5,[R2, #+0]
//  130     }
//  131 
...
//  134       PORTC->PCR[16] = PORT_PCR_MUX(2)| PORT_PCR_PE_MASK | PORT_PCR_PS_MASK; 
        LDR.W    R2,??DataTable12_12  ;; 0x4004b040
        MOVW     R3,#+515
        STR      R3,[R2, #+0]
        B.N      ??LPLD_CAN_Init_6
//  135     }
...
??LPLD_CAN_Init_9:
        LDR.W    R2,??DataTable12_13  ;; 0x4004d064
        MOVW     R3,#+515
        STR      R3,[R2, #+0]
//  139     }
//  140   } 	 
...
LPLD_CAN_SetBaudRate:
        ...
        LDR.W    R3,??DataTable12_14  ;; 0x186a0
        CMP      R2,R3
        BEQ.N    ??LPLD_CAN_SetBaudRate_0
        LDR.W    R3,??DataTable12_15  ;; 0x3d090
        CMP      R2,R3
        BEQ.N    ??LPLD_CAN_SetBaudRate_0
        LDR.W    R3,??DataTable12_16  ;; 0x7a120
        CMP      R2,R3
        BEQ.N    ??LPLD_CAN_SetBaudRate_0
        LDR.W    R3,??DataTable12_17  ;; 0xf4240
        CMP      R2,R3
        BNE.N    ??LPLD_CAN_SetBaudRate_1
//  271   {
...
//  315   
//  316   if(canx == CAN0)
        LDR.W    R0,??DataTable12_3  ;; 0x40024000
        CMP      R4,R0
...
??LPLD_CAN_Deinit_0:
        LDR.W    R0,??DataTable12_5  ;; 0x40048030
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x10
        LDR.W    R1,??DataTable12_5  ;; 0x40048030
        STR      R0,[R1, #+0]
...
//  345     
//  346   if(canx == CAN0)
        LDR.W    R1,??DataTable12_3  ;; 0x40024000
        CMP      R0,R1
...
??LPLD_CAN_EnableIrq_0:
        LDR.W    R1,??DataTable12_19  ;; 0x400a4000
        CMP      R0,R1
...
//  788     id_temp =  CAN_MB_ID_STD(message_id);
        LDR.N    R3,??DataTable12_22  ;; 0x1ffc0000
...
// 1017    LPLD_CAN_Interrupt_ClearPending(canx,msg_num);
        ...
        BL       LPLD_CAN_Interrupt_ClearPending
// 1018    if(canx == CAN0)
        LDR.N    R0,??DataTable12_3  ;; 0x40024000
        CMP      R5,R0
...
??LPLD_CAN_Transmit_Interrupt_1:
        LDR.N    R0,??DataTable12_19  ;; 0x400a4000
        CMP      R5,R0
...
??LPLD_CAN_CAN0_Interrupt_Handler_0:
        UXTB     R5,R5            ;; ZeroExt  R5,R5,#+24,#+24
        CMP      R5,#+16
        BCS.N    ??LPLD_CAN_CAN0_Interrupt_Handler_3
        UXTB     R5,R5            ;; ZeroExt  R5,R5,#+24,#+24
        LSLS     R0,R5,#+4
        LDR      R0,[R0, R4]
        UXTB     R5,R5            ;; ZeroExt  R5,R5,#+24,#+24
...
??LPLD_CAN_CAN1_Interrupt_Handler_0:
        UXTB     R5,R5            ;; ZeroExt  R5,R5,#+24,#+24
        CMP      R5,#+16
        BCS.N    ??LPLD_CAN_CAN1_Interrupt_Handler_3
        UXTB     R5,R5            ;; ZeroExt  R5,R5,#+24,#+24
        LSLS     R0,R5,#+4
        LDR      R0,[R0, R4]
        UXTB     R5,R5            ;; ZeroExt  R5,R5,#+24,#+24
...
// 2 464 bytes in section .text
// 
// 2 464 bytes of CODE  memory
